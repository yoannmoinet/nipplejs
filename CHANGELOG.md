...
-   **thumb:** remove size of container and apply on children only ([0033342](https://github.com/yoannmoinet/nipplejs/commit/0033342)), closes [#32](https://github.com/yoannmoinet/nipplejs/issues/32)
...
-   **thumb:** fragment control of previous directions ([790fa26](https://github.com/yoannmoinet/nipplejs/commit/790fa26)), closes [#25](https://github.com/yoannmoinet/nipplejs/issues/25)

### Features

-   **thumb:** add `resetDirection()` to cancel previous directions ([66f6e3b](https://github.com/yoannmoinet/nipplejs/commit/66f6e3b))
...
-   **thumb:** call off() after triggering ([bf8e5c3](https://github.com/yoannmoinet/nipplejs/commit/bf8e5c3))
-   **thumb:** only trigger itself, not its manager ([6b39786](https://github.com/yoannmoinet/nipplejs/commit/6b39786))
...
-   return the found thumb in `get()` ([439aa69](https://github.com/yoannmoinet/nipplejs/commit/439aa69))
-   unbind document when collection is manually destroyed ([6e66b62](https://github.com/yoannmoinet/nipplejs/commit/6e66b62))

### Features

-   **thumb:** add an incremental id to absolutely differentiate each ([598a5eb](https://github.com/yoannmoinet/nipplejs/commit/598a5eb))
...
-   safety clean if thumb isn't found in collection ([ca20985](https://github.com/yoannmoinet/nipplejs/commit/ca20985))
...
-   **thumb:** use `document.body.contains` for IE11 doesn't shortcut ([6e5b80a](https://github.com/yoannmoinet/nipplejs/commit/6e5b80a)), closes [#17](https://github.com/yoannmoinet/nipplejs/issues/17)
...
-   **thumb:** remove useless backPosition ([4c76adc](https://github.com/yoannmoinet/nipplejs/commit/4c76adc))
...
-   **thumb:** control dom presence before add or remove ([7cc1d8c](https://github.com/yoannmoinet/nipplejs/commit/7cc1d8c))
-   **thumb:** return the manager's known object in event triggers ([2deb42c](https://github.com/yoannmoinet/nipplejs/commit/2deb42c))
...
-   **manager:** expose thumbOptions ([968103c](https://github.com/yoannmoinet/nipplejs/commit/968103c))
...
-   **thumb:** add destroy method ([713e505](https://github.com/yoannmoinet/nipplejs/commit/713e505))
-   **thumb:** remove position offset ([be59bc4](https://github.com/yoannmoinet/nipplejs/commit/be59bc4))
...
-   add more events for both thumb and manager ([f7966b9](https://github.com/yoannmoinet/nipplejs/commit/f7966b9))
...
-   attach values to each instance of thumb ([c5bf9ab](https://github.com/yoannmoinet/nipplejs/commit/c5bf9ab))
-   limit the number of simultaneous thumbs ([801e91d](https://github.com/yoannmoinet/nipplejs/commit/801e91d))
...
-   **thumb:** add a callback after show and hide ([5b24124](https://github.com/yoannmoinet/nipplejs/commit/5b24124))
-   **thumb:** add the positions to the instance ([fac981b](https://github.com/yoannmoinet/nipplejs/commit/fac981b))
