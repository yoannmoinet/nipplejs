...
Enable this when your page has dynamically visible elements (e.g. elements toggled by Vue, React, Angular, or CSS). It forces a recalculation of the joystick position on every move event.

This has a notable performance cost, so only enable it when necessary.
