            ...
            zones: [
                {
                    options: {
                        ...
                        color: {
                            front: 'url("/nipplejs/assets/move.svg") center/75% no-repeat, linear-gradient(135deg, #818cf8, #38bdf8)',
                ...
                },
                {
                    options: {
                        ...
                        color: {
                            front: 'url("/nipplejs/assets/shoot.svg") center/75% no-repeat, linear-gradient(135deg, #e879f9, #ec4899)',
